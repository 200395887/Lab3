...
function result() {
  ...
  story.insertAdjacentHTML("afterend", '<div class="card-body"></div>');
  let value = document.querySelector(".card-body");
  value.textContent = newStory;
...
//Trying to make the "Enter" key working.
